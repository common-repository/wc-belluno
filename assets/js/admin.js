(function ( $ ) {
	...
	$(function () {
		var api = $( '#woocommerce_belluno_api' ),
			creditcard = $( '#woocommerce_belluno_credit_card' ),
			installments = $( '#woocommerce_belluno_installments' ),
			receipt = $( '#woocommerce_belluno_installments_receipt' ),
			billet = $( '#woocommerce_belluno_billet_banking' ),
			billetActive = $( '#woocommerce_belluno_billet' ),
			billetTime = $( '#woocommerce_belluno_billet_type_term' );
